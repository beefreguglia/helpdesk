/*
  ...
  - You are about to drop the column `price_at_time` on the `call_services` table. All the data in the column will be lost.
...
INSERT INTO "new_call_services" ("call_id", "created_at", "id", "service_id") SELECT "call_id", "created_at", "id", "service_id" FROM "call_services";
